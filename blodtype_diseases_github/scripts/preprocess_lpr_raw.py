...
# Select dieases codes of only people with a meassured bloodtype
bloodtypes = pd.read_csv(snakemake.input["bloodtypes"],sep="\t",names=["cpr_enc","Date_bt_meassured","Bloodtype","AB0","Rhesus"])
master = master[master.cpr_enc.isin(bloodtypes.cpr_enc)].copy()
